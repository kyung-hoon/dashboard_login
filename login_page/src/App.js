...
import FindPASSWORDScreen from './components/FindPASSWORDScreen.js';
import DashBoardLoginScreen from './components/DashBoard_LoginScreen.js';
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        ...
        case 'findpassword':
          return (<FindPASSWORDScreen {...screenProps} />)
        case 'dashboard_login':
          return (<DashBoardLoginScreen {...screenProps} />)
      }
    }
    ...
    return (
      <div className="App">
        <Switch>
          <Route path="/" render={(props) => makeElementForScreen('dashboard_login', props.location.state, true, true)} exact />
          <Route path="/signin" render={(props) => {
            return makeElementForScreen('signin', props.location.state, true, true);
          }} />
          <Route path="/findpassword" render={(props) => {
            return makeElementForScreen('findpassword', props.location.state, true, true);
          }} />
          <Route path="/dashboard_login" render={(props) => {
            return makeElementForScreen('dashboard_login', props.location.state, true, true);
          }} />
        </Switch>
      </div>
    );
